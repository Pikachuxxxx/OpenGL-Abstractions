...
class AdvancedGLScene : public Sandbox
{
private:
    Cube cube;
    Quad plane;
...
public:
    AdvancedGLScene() : meshShader("./src/shaders/mesh.vert", "./src/shaders/texture.frag"), metal("./src/textures/metal.png", 0), marble("./src/textures/marble.jpg", 0),

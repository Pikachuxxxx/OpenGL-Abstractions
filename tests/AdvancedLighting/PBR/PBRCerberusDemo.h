...
public:
    ...
    //Models
    CerberusPBRModel("./tests/models/Cerberus_by_Andrew_Maximov/Cerberus.obj"),
    ...
    // Textures
    albedo("./tests/models/Cerberus_by_Andrew_Maximov/Textures/Cerberus_A.tga",0),
    normal("./tests/models/Cerberus_by_Andrew_Maximov/Textures/Cerberus_N.tga",1),
    ...
    lutVisFBO(window.getWidth(), window.getHeight())
    {
        ...
        speculaIBLTexturedShader.setUniform1i("metallicMap", 2);
        speculaIBLTexturedShader.setUniform1i("roughnessMap", 3);
        speculaIBLTexturedShader.setUniform1i("aoMap", 4);
        // cubemaps + LUT
        speculaIBLTexturedShader.setUniform1i("irradianceMap", 5);
        speculaIBLTexturedShader.setUniform1i("prefilterMap", 6);
        speculaIBLTexturedShader.setUniform1i("brdfLUT", 7);

        cerberusTransform = Transform(glm::vec3(0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(2.0f));
    }

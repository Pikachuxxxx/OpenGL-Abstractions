...
public:
    Scene() : sponza("./tests/models/Sponza/sponza.obj"), pointLightShader("./tests/shaders/mesh.vert", "./tests/shaders/Lighting/pointLight.frag")
    {

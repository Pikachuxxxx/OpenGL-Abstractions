...
private:
    ...
    float extent = 0.25;
public:
    Scene() : Sandbox("Deffered Rendering"), wood("./tests/textures/wood.png", 0), marble("./tests/textures/marble.jpg", 0),
    ...
    saveFBO(window.getWidth(), window.getHeight()), vignetteShader("./tests/shaders/quad.vert", "./tests/shaders/FX/vignette.frag")
     {}
    ~Scene() {}

...
public:
    ...
    {
        glPointSize(10.0f);
        DrawLine(glm::vec3(0.0f), glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.0f, 0.0f));
        DrawLine(glm::vec3(0.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        DrawLine(glm::vec3(0.0f), glm::vec3(0.0f, 0.0f, sin(glfwGetTime())), glm::vec3(0.0f, 0.0f, 1.0f));

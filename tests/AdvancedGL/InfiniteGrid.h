...
public:
    ...
    infiniteGridShader("./tests/shaders/infiniteGrid.vert", "./tests/shaders/infiniteGrid.frag"),
...
//------------------------------------------------------------------------------
    ...
    void OnRender() override
    {
        ...
        renderer.draw_no_buffer(Origin, infiniteGridShader, 6);
        ////////////////////////////////////////////////////////////////////////
